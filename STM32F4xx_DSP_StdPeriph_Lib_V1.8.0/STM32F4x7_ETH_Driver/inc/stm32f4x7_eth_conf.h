...
/**************************PHY-LAN8720A Registers********************************/

#define LAN8720_BCR 		       ((uint16_t)0x0000) /* PHY  Status */
#define LAN8720_BSR 		       ((uint16_t)0x0001) /* PHY  Status */
#define LAN8720_ID1	 		       ((uint16_t)0x0002) /* PHY  Status */
#define LAN8720_ID2 		       ((uint16_t)0x0003) /* PHY  Status */
#define LAN8720_ANAR 		       ((uint16_t)0x0004) /* Auto Negotiation Advertisement Register */
#define LAN8720_ANLPAR	       ((uint16_t)0x0005) /* Auto Negotiation Link Partner Ability Register */
#define LAN8720_ANER 		       ((uint16_t)0x0006) /* Auto Negotiation Expansion Register */
#define LAN8720_MCSR 		       ((uint16_t)0x0011) /* Mode Control/Status Register */
#define LAN8720_SMR 		       ((uint16_t)0x0012) /* Special Modes Register */
#define LAN8720_SECR 		       ((uint16_t)0x001A) /* Symbol Error Counter Register */
#define LAN8720_SCSIR		       ((uint16_t)0x001B) /* Special Control/Status Indications Register */
#define LAN8720_ISFR 		       ((uint16_t)0x001D) /* Interrupt Source Flag Register */
#define LAN8720_IMR 		       ((uint16_t)0x001E) /* Interrupt Mask Register */
#define LAN8720_PSCSR		       ((uint16_t)0x001F) /* PHY Special Control/Status Register */
